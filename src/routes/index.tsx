        ...
        <section id="about" className="section-shell scroll-mt-20" data-reveal>
          ...
          <Slider
            ...
            items={[{ n: "01", a: "Bring value", b: "Take value." }, { n: "00", a: "No spam", b: "No cold pitching." }, { n: "∞", a: "Skills", b: "Trade what you know." }].map((item) => (
              <div key={item.a} className="card-lift flex h-full flex-col justify-between border border-border bg-surface/30 p-6 sm:block sm:border-0 sm:border-r sm:bg-transparent sm:px-8 sm:py-9 sm:first:pl-0 sm:last:border-r-0">
          ...
          <div className="px-5 pb-20 pt-10 sm:hidden">
            <Slider
              ...
              items={features.map((feature) => (
                <div key={feature.number} className="card-lift flex h-full flex-col border border-border bg-surface/30 p-6">
...
function CommunityCanvas() { return <div className="community-lines relative min-h-[470px] overflow-hidden border border-border bg-surface/30 p-4 sm:min-h-[520px] sm:p-10"><div className="node-breathe absolute left-[18%] top-[20%] size-2 rounded-full bg-primary" /><div className="node-breathe absolute bottom-[21%] right-[18%] size-2 rounded-full bg-primary" style={{ animationDelay: "2s" }} /><Chat text="Need a React developer for a startup MVP." tag="Development" className="chat-reveal relative z-10 max-w-[92%] sm:max-w-sm" /><Chat text="I can help with frontend." tag="React" className="chat-reveal relative z-10 ml-auto mt-9 max-w-[85%] sm:mt-14 sm:max-w-xs" accent /><div className="my-8 flex items-center gap-3 sm:hidden"><span className="h-px flex-1 bg-border" /><span className="font-display text-[9px] uppercase tracking-[.14em] text-primary">Skill match · React · Frontend · MVP</span><span className="h-px flex-1 bg-border" /></div><Chat text="Looking for someone strong in branding." tag="Design" className="chat-reveal relative z-10 mt-9 max-w-[92%] sm:mt-14 sm:max-w-sm" /><Chat text="Let's collaborate." tag="Startup" className="chat-reveal relative z-10 ml-auto mt-9 max-w-[78%] sm:mt-12 sm:max-w-xs" accent /></div>; }
